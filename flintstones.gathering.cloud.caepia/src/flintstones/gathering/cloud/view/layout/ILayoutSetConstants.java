...
public interface ILayoutSetConstants {
	 ...
	 * LayoutSet Ids
	 */
	public static final String SET_ID_CONFIG_DIALOG = "org.eclipse.rap.design.example.layoutset.confdialog"; //$NON-NLS-1$
	public static final String SET_ID_COOLBAR = "org.eclipse.rap.design.example.layoutset.coolbar"; //$NON-NLS-1$
	public static final String SET_ID_OVERFLOW = "org.eclipse.rap.design.example.layoutset.coolbaroverflow"; //$NON-NLS-1$
	public static final String SET_ID_FOOTER = "org.eclipse.rap.design.example.layoutset.footer"; //$NON-NLS-1$
	public static final String SET_ID_HEADER = "org.eclipse.rap.design.example.layoutset.header"; //$NON-NLS-1$
	public static final String SET_ID_LOGO = "org.eclipse.rap.design.example.layoutset.logo"; //$NON-NLS-1$
	public static final String SET_ID_MENUBAR = "org.eclipse.rap.design.example.layoutset.menubar"; //$NON-NLS-1$
	public static final String SET_ID_PERSP = "org.eclipse.rap.design.example.layoutset.perspective"; //$NON-NLS-1$
	public static final String SET_ID_STACKPRESENTATION = "org.eclipse.rap.design.example.layoutset.stack"; //$NON-NLS-1$
