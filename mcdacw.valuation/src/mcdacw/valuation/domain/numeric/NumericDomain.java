 ...
 * @version 1.0
 */
public class NumericDomain implements INumericDomain, IDomain {
	...
	/**
	 * Constructor por defecto de NumericDomain.
	 * <p>
	...
	/**
	 * Constructor de NumericDomain indicando los límites inferior y superior.
	 * <p>
	 * El dominio será de tipo REAL.
	 * 
	 * @param min
	 ...
	 *             Si min > max.
	 */
	public NumericDomain(double min, double max) {
		_type = REAL;
		_inRange = true;
		setMinMax(min, max);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see mcdacw.valuation.domain.numeric.INumericDomain#setMinMax(double,
	 * double)
	 */
	@Override
	...
	public boolean equals(Object object) {
		...
		final NumericDomain other = (NumericDomain) object;
	...
	public static NumericDomain fromString(String value) {
