...
import mcdacw.valuation.domain.DomainFactory;
import mcdacw.valuation.domain.IDomain;
import mcdacw.valuation.domain.numeric.NumericDomain;

/**
 * Conjunto de etiquetas difuso para Hesitant.
 * 
 * @author Estrella Liébana, Francisco Javier
 * @version 1.0
 */
public class HesitantFuzzySet extends LabelSet implements IDomain, Cloneable {
	 ...
	 */
	public HesitantFuzzySet(List<Label> labels) {
		this();
		setLabels(labels);
	}
	 ...
	 */
	public HesitantFuzzySet(List<Label> labels, List<Double> measures) {
		this(labels);
	...
	/**
	 * Comprueba si el HesitantFuzzySet es una partición difusa.
	 * 
	 * @return True si el HesitantFuzzySet es una partición difusa.
	 *         <p>
	 *         False si el HesitantFuzzySet no es una partición difusa.
	 */
	...
	/**
	 * Comprueba si un HesitantFuzzySet está conformado por etiquetas triangulares.
	 * 
	 * @return True si el HesitantFuzzySet está conformado por etiquetas triangulares.
	 *         <p>
	 *         False si el HesitantFuzzySet no está conformado por etiquetas
	 *         triangulares.
	 */
	...
	/**
	 * Comprueba si un HesitantFuzzySet es un TOR (Triangular Odd Ruspini).
	 * 
	 * @return True si el HesitantFuzzySet es un TOR.
	 *         <p>
	 *         False si sel HesitantFuzzySet no es un TOR.
	 */
	...
	/**
	 * Comprueba si el HesitantFuzzySet es simétrico.
	 * 
	 * @return True si el HesitantFuzzySet es simétrico.
	 *         <p>
	 *         False si el HesitantFuzzySet no es simétrico.
	 */
	...
	/**
	 * Comprueba si el HesitantFuzzySet es uniforme.
	 * 
	 * @return True si el HesitantFuzzySet es uniforme.
	 *         <p>
	 *         False si el HesitantFuzzySet no es uniforme.
	 */
	...
	/**
	 * Comprueba si el HesitantFuzzySet es un BLTS (Basic Linguistic Term Set).
	 * 
	 * @return True si el HesitantFuzzySet es un BLTS.
	 *         <p>
	 *         False si el HesitantFuzzySet no es un BLTS.
	 */
	 ...
	 * 
	 * @return Sumario del HesitantFuzzySet.
	 */
	...
	public boolean equals(Object object) {
		...
		final HesitantFuzzySet other = (HesitantFuzzySet) object;
	...
	public Object clone() {
		...
		((HesitantFuzzySet) result)._measures = measures;

		return result;
	}

	
	public static HesitantFuzzySet fromString(String value) {
		...
		try {
			...
			int pos = 0;
			for (String t : tokens) {
				labels[pos++] = t.split("\\:")[0];
			}
			DomainFactory factory = mcdacw.valuation.domain.Activator.getActivator().getDomainFactory();
			result = factory.buildHesitantFuzzySetDomain(labels);
